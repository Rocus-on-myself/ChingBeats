<template>
  <div class="song-container">
    <el-image class="song-pic" id="songPl" fit="contain" :src="attachImageUrl(songPic)" />
    <ul class="song-info">
      <li>歌手：{{ singerName }}</li>
      <li>歌曲：{{ songTitle }}</li>
    </ul>
...
export default defineComponent({
  ...
  setup() {
    ...
    watch(isPlay, ()=> {
      ...
      const picId = document.querySelector('.song-pic') as HTMLElement
      console.log(picId)
      if (isPlay.value) {
        picId.style.animationPlayState = 'running';
      } else {
        picId.style.animationPlayState = 'paused';
      }
    })
