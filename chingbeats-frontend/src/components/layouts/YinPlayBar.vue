<template>
  <div class="play-bar" :class="{ show: !toggle }">
    ...
    <!--播放进度-->
    <el-slider class="progress" :show-tooltip="true" :format-tooltip="formatTime" v-model="nowTime" @change="changeTime" size="small"></el-slider>
...
export default defineComponent({
  ...
  methods: {
    formatTime(seconds) {
      let real = seconds / 100 * this.duration
      return formatSeconds(real)
    },
    changeAside() {
