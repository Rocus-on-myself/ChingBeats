<template>
  <div class="yin-header">
    ...
    <div class="header-logo" @click="goPage()">
      <div class="icon-du">
        <img src="@/assets/images/dM-3.png" alt="" height="36" class="icon-du-img">
      </div>

<!--      <yin-icon :icon="iconList.ERJI"></yin-icon>-->
<!--      <el-icon color="#000"><Headset /></el-icon>-->
      <span>{{ musicName }}</span>
    </div>
...
.header-logo {
  ...
  .icon {
    ...
    //@include icon(1.9rem, $color-ching);
